...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("MultiplayerTest", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("MultiplayerTest", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "MultiplayerTest";
		app.meta["name"] = "MultiplayerTest";
